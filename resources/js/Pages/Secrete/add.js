...
export default function Secrete() {
        ...
        <Layout>
            ...
            <div className="mb-3">
              ...
              <div className="mb-3">
                ...
                <textarea name='secure_notes' className="form-control" id="notes" rows="3" onChange={e => setData('secure_notes', e.target.value)}>{data.notes}</textarea>
            </div>
